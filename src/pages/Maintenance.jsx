...
export const Maintenance = () => {
  return (
    <section className="relative overflow-hidden bg-zinc-950 h-screen flex flex-col justify-center">
      <Content />
      <Beams />
      <GradientGrid />
    </section>
...
const Content = () => {
  return (
    <div className="relative z-20 mx-auto flex max-w-6xl flex-col items-center justify-center px-4 py-24 mb-20 md:px-8 md:py-36">
      <motion.div
        initial={{
          y: 25,
          opacity: 0,
        ...
        className="relative"
      >
        <GlowingChip>Under Maintenance 🚧</GlowingChip>
      </motion.div>
      <motion.h1
        initial={{
          y: 25,
